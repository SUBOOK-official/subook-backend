-- 어드민 목록 RPC 3종에 페이지네이션 메타(total_count) 재적용.
--
-- 20260518091121_admin_list_pagination_meta_rollback으로 일시 되돌렸던 응답 형태
-- ({ items, total_count })를 다시 적용한다. admin-web frontend가 호환 모드로
-- 배포 완료된 후에 push 한다.
